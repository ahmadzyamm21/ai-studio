...
export default function ReferenceImageCard({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm" title={tooltip}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={`rounded-full px-2 py-1 text-[10px] font-semibold uppercase ${
                hasImage ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'
              }`}
            >
